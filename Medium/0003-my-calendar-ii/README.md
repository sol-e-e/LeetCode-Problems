<h2><a href="https://leetcode.com/problems/my-calendar-ii">3. My Calendar II</a></h2><h3>Medium</h3><hr><p>You are implementing a program to use as your calendar. We can add a new event if adding the event will not cause a <strong>triple booking</strong>.</p>
